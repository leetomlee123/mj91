...
import 'package:mj91/pages/movie_search/searchBarDelegate.dart';
    ...
    return Obx(() => controller.initOk.isTrue
        ? Scaffold(
            appBar: AppBar(
              ...
              title: Text("Movie"),
              actions: [
                IconButton(onPressed: () {showSearch(context: context, delegate: searchBarDelegate());}, icon: Icon(Icons.search)),
                SizedBox(
                  width: 3,
                )
              ],
